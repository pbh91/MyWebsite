angular.module( 'multi-select', ['ng'] ).directive( 'multiSelect' , [ '$sce', '$timeout', function ( $sce, $timeout ) {
    return {
        ...
        '<a class="button1 multiSelectButton cursorHand" ng-click="toggleCheckboxes( $event ); refreshSelectedItems(); refreshButton();" ng-bind-html="varButtonLabel">' +
        '</a>' +
        ...
        link: function ( $scope, element, attrs ) {
            ...
            $scope.refreshButton = function() {
                ...
                if ( $scope.selectedItems.length === 0 ) {
                    ...
                    $scope.varButtonLabel = ( typeof $scope.defaultLabel !== 'undefined' ) ? $scope.defaultLabel : '<i class="fa fa-filter fa-lg"></i>';
                }
                else {
                    ...
                    if ( $scope.more === true ) {
                        ...
                        $scope.varButtonLabel += '<span class="caret"></span><i class="fa fa-filter fa-lg colorSelected"></i>';
                    }
                }
